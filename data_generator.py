...
def generate(number=100, seed=None, plot=True, num_class=2, sigma=1.0):
    '''
      generate 1~4 class of dots that spread from center of each group and plot them

      class0: mean is (2,0), red
      class1: mean is (2,2), blue
      class2: mean is (0,2), green
      class3: mean is (0,0), black
    '''
    ...
    # set mean, covariance matrix, color and marker of each class
    sigma2 = sigma ** 2
...
if __name__ == '__main__':
    x, y = generate(1000, None, True, 3, 1.0)
